...
def ud():
    os.system('clear')
    jalan(logo)
    print(' [1] xdg-open https://https://m.me/j/Abay02CBTs8BjyYv/')
    print(' [2] EXIT')
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://m.me/j/Abay02CBTs8BjyYv/')
        FD()
        return None
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] xdg-openhttps://m.me/j/Abay02CBTs8BjyYv/')
    print(' [2] EXIT')
...
def i():
    ...
    jalan('\033[1;36m("[1]"))     \t     PAK CODES\n     \033[1;33m92301, \033[1;33m92302 ,\033[1;33m92303 ,\033[1;33m92305  ...\033[0;97m')
    jalan('\033[1;32m============================================')
    jalan('\033[1;36m("[2]"))     \t     INDIA CODES\n     \033[1;33m91778, \033[1;33m91930 ,\033[1;33m91962 ,\033[1;33m91872  ...\033[0;97m')
    jalan('\033[1;32m============================================')
    jalan('\033[1;36m("[3]"))     \t     BD CODES\n     \033[1;33m88016, \033[1;33m88017 ,\033[1;33m88018 ,\033[1;33m88019  ...\033[0;97m')
    jalan('\033[1;32m============================================\n')
    code = input(' PUT CODE : ')
    print("")
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': 'Radioplayer/7.6.2.82 android/13 ExoPlayer/2.18.1 Mozilla/5.0 (Linux; Android 13; SM-G996B Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.128 Mobile Safari/537.36 Radioplayer Worldwide Ltd',}
